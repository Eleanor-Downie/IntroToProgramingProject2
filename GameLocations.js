...
function Item (id, name, description, isTaken){
   ...
   //Items can't be in a function because one of my functions in my html uses them so they have to be global
...
function locationsInit(){
   ...
   var desertPlanet = new Location();
      ...
      desertPlanet.description = "You have voyaged to the hot and sandy planet of Arrakis. This desert planet seems to be barren and just bearably hot, but as time goes on as you are exploring, you find more evidence of sand worms...until there are groups of them comming towards your ship.";
   ...
   var earthPlanet = new Location();
      ...
      earthPlanet.description = "Congratulations! You have made it to the unknown planet that is very similar to the planet Earth. You are the first to discover this new planet!";
